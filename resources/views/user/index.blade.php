...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('styleUser/style/favicon.ico')}}" type="image/webp">
    <link rel="icon" href="{{ asset('styleUser/style/favicon.ico')}}" type="image/webp">
    ...
    <meta property="og:image:secure_url" content="https://raw.githubusercontent.com/SamirPaulb/assets/main/samir.webp"/>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('styleUser/style/favicon.ico')}}">
...
<body>
    <div class="min-h-full flex-h-center" id="background_div">
        <input type="hidden" value="https://bio.link" id="app-url">
                    <input type="hidden" value="null" id="is-featured">
                                                ...
                                                <img
                    class="page-image"
                    data-src="{{ asset('styleUser/style/red.png')}}"
    ...
    <div class="mt-48 page-full-wrap relative ">
        ...
        <img
            ...
            data-src="{{ asset('styleUser/style/logo.png')}}"
        ...
        <div class="mt-24">
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="261652" data-type="page_item">
                                    ...
                                    data-src="{{ asset('styleUser/style/linkedin.png')}}"
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="261686" data-type="page_item">
                                                            <img
                                    class="link-each-image"
                                    data-src="{{ asset('styleUser/style/insta.png')}}"
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="261687" data-type="page_item">
                                                            <img
                                    class="link-each-image"
                                    data-src="{{ asset('styleUser/style/fb.png')}}"
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="261681" data-type="page_item">
                                                            <img
                                    class="link-each-image"
                                    data-src="{{ asset('styleUser/style/tw.png')}}"
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="262545" data-type="page_item">
                                                            <img
                                    class="link-each-image"
                                    data-src="{{ asset('styleUser/style/pin.png')}}"
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="261717" data-type="page_item">
                                                            <img
                                    class="link-each-image"
                                    data-src="{{ asset('styleUser/style/rd.png')}}"
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="261771" data-type="page_item">
                                                            <img
                                    class="link-each-image"
                                    data-src="{{ asset('styleUser/style/web.png')}}"
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="261685" data-type="page_item">
                                                            <img
                                    class="link-each-image"
                                    data-src="{{ asset('styleUser/style/git.png')}}"
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="261701" data-type="page_item">
                                                            <img
                                    class="link-each-image"
                                    data-src="{{ asset('styleUser/style/leet.png')}}"
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="261707" data-type="page_item">
                                                            <img
                                    class="link-each-image"
                                    data-src="{{ asset('styleUser/style/code.png')}}"
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="261709" data-type="page_item">
                                                            <img
                                    class="link-each-image"
                                    data-src="{{ asset('styleUser/style/hack.png')}}"
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="261710" data-type="page_item">
                                                            <img
                                    class="link-each-image"
                                    data-src="{{ asset('styleUser/style/geek.png')}}"
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="261711" data-type="page_item">
                                                            <img
                                    class="link-each-image"
                                    data-src="{{ asset('styleUser/style/med.png')}}"
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="261714" data-type="page_item">
                                                            <img
                                    class="link-each-image"
                                    data-src="{{ asset('styleUser/style/dev.png')}}"
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="262560" data-type="page_item">
                                                            <img
                                    class="link-each-image"
                                    data-src="{{ asset('styleUser/style/rep.png')}}"
                        ...
                        <a target="_blank"  class="page-item-each py-10 flex-both-center"
                           ...
                           data-id="262840" data-type="page_item">
                                                            <img
                                    class="link-each-image"
                                    data-src="{{ asset('styleUser/style/koo.png')}}"
