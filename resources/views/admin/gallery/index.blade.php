            ...
            <div class="card w-100">
                <div class="card-body p-4">
                    <div class="navbar navbar-expand-lg navbar-light">
                        <ul class="navbar-nav">
                            <h5 class="card-title fw-semibold">Thumbnail Gallery</h5>
                        </ul>
                        <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
                            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                                <a href="{{ route('thumbnail-gallery.create') }}" class="btn btn-danger">Tambah Thumbnail</a>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-bottom-0 text-center">
                                            ...
                                            <form action="{{ route('thumbnail-gallery.destroy', $g->id) }}"
                                                ...
                                                @method('delete')
                                                @csrf
                                                <button aria-label="Hapus Thumbnail Gallery" class="btn btn-danger show_confirm" type="submit"><svg xmlns="http://www.w3.org/2000/svg"
