            ...
            <div class="card w-100">
                <div class="card-body p-4">
                    <div class="navbar navbar-expand-lg navbar-light">
                        <ul class="navbar-nav">
                            <h5 class="card-title fw-semibold">Thumbnail Group</h5>
                        </ul>
                            ...
                            <tbody>
                                @foreach ($group as $index => $g)
                                    <tr>
                                        ...
                                        <td class="border-bottom-0 text-center">
                                            <form action="{{ route('thumbnail.updateGroup', $g->id) }}"
                                                method="post">
                                                @csrf
                                        ...
                                        <td class="border-bottom-0 text-center">
                                            <a aria-label="Edit Thumbnail Group" href="{{ route('thumbnail-group.edit', $g->id) }}"
                                            ...
                                            <form action="{{ route('thumbnail-group.destroy', $g->id) }}"
                                                method="post">
                                                @method('delete')
                                                @csrf
